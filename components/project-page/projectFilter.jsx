  ...
  return (
    <div className="w-full transition-all border-t">
      <button
        ...
        className="font-semibold p-3 w-full flex justify-between items-center"
      >
        {name}
        <GoChevronDown
          className={`text-2xl transition-all ${isOpen && "rotate-180"}`}
        />
      </button>
      <ul
        className={`border-l ml-3 my-2 transition-all duration-300 overflow-auto ${
          isOpen ? "max-h-72" : "-mb-2 max-h-0 overflow-hidden"
        }`}
      >
        {children}
      </ul>
...
export const ProjectTypes = () => {
  ...
  return (
    <FilterWrapper name="Type">
      <li onClick={() => setProjects(projectsData)} className="filter-li">
        All
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(0))
          )
        }
        className="filter-li"
      >
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(1))
          )
        }
        className="filter-li"
      >
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(2))
          )
        }
        className="filter-li"
      >
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(3))
          )
        }
        className="filter-li"
      >
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(4))
          )
        }
        className="filter-li"
      >
      ...
      <li
        onClick={() =>
          setProjects(
            [...projectsData].filter((item) => item.types.includes(5))
          )
        }
        className="filter-li"
      >
...
export const ProjectTechs = () => {
  return (
    <FilterWrapper name="Technologies">
      ...
      <li className="filter-li">
        Mui
        <SiMui className="text-xl" />
      </li>
      <li className="filter-li">
        Redux
        <TbBrandRedux className="text-xl" />
      </li>
      <li className="filter-li">
        Figma
      ...
      <li className="filter-li">
        Three js
        <SiThreedotjs className="text-xl" />
      </li>
      <li className="filter-li">
        Sass
        <TbBrandSass className="text-xl" />
      </li>
      <li className="filter-li">
        React query
        <SiReactquery className="text-xl" />
      </li>
      <li className="filter-li">
        Jest
  ...
  return (
    <FilterWrapper name="Sort">
      <li
        ...
        className={`filter-li ${!isDescending && "bg-neutral-700 text-white"}`}
      >
        Ascending
        <PiSortAscending className="text-xl" />
      </li>
      <li
